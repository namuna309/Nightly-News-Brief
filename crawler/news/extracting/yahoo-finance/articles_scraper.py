        ...
        for i in range(5):
            ...
            try:
                ...
                try:
                    ...
                    print(f"failed to get 'title' with error: {e}. url: {self.url}")
                    self.article['title'] = ""
                ...
                if byline_author:
                    try:
                        ...
                        print(f"failed to get 'authors' with error: {e}. url: {self.url}")
                ...
                try:
                    ...
                    print(f"failed to get 'date' with error: {e}. url: {self.url}")
                    self.article['date'] = ""
                ...
                if body_wrap:
                    try:
                        ...
                        print(f"failed to get 'text' with error: {e}. url: {self.url}")
                        self.article['text'] = ""
                else:
                    self.article['text'] = ""
